#!/usr/bin/env python3
"""
server.py - Kanban QA Dashboard (Hub proxy to Argus workspace)
Serves UI from here, but data from workspace-argus
"""
...
# Data from Argus workspace
ARGUS_WS = Path("/home/jmfraga/.openclaw/workspace-argus")
DATA_DIR = ARGUS_WS / "kanban-qa" / "data"
CONFIG_DIR = ARGUS_WS / "kanban-qa" / "config"
KANBAN_FILE = DATA_DIR / "kanban.json"
TOKEN_FILE = DATA_DIR / "token-usage.json"
CONFIG_FILE = CONFIG_DIR / "agents-config.json"
AUDIT_STATS_FILE = ARGUS_WS / "qa" / "audit-stats.json"
...
def main():
    ...
    with socketserver.TCPServer(("", PORT), KanbanRequestHandler) as httpd:
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(f"🚀 Kanban QA Dashboard (Hub) running on http://localhost:{PORT}")
        print(f"📂 Data source: {ARGUS_WS}")
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print("")
